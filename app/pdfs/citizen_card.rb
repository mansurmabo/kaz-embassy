class CitizenCard < Prawn::Document
  ...
  def main
    ...
    text "Дата Рождения: #{@citizen.birthday}"
  ...
  def passport
    ...
    text "Дата выдачи: #{@passport.date_of_issue}"
    text "Срок действия: #{@passport.date_of_validity}"
  ...
  def description
    ...
    text "Дата Место работы или учебы в РК: #{@citizen.kaz_work_place}"
